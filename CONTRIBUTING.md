...
- There may be some delay before maintainers comment on a pull request
...
1. **Build**: Ensure it builds without errors for target platforms
2. **Test**: Test your changes on hardware if possible, else QEMU
3. **Verify**: Verify existing functionality still works
...
By contributing to WallaBMC, you agree that your contributions will be
